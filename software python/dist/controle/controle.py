...
def lista():
    lista.show()
    cursor = conexao.cursor()
    comando_SQL = 'SELECT * FROM cadastro_produtos.produtos'
    ...
    colunas = ['ID', 'Produto', 'Preço', 'Estoque']
    lista.tableWidget.setHorizontalHeaderLabels(colunas)
...
def inserir():
    ...
    formulario.lblConfirmacao.setText('DADOS INCERIDOS COM SUCESSO!')
